        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 border-b border-white pb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/" className="hover:text-[#e57339]">Home</Link></li>
              <li><Link to="/about" className="hover:text-[#e57339]">About Us</Link></li>
              <li><Link to="/contact" className="hover:text-[#e57339]">Contact</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <Link to='/' className="text-2xl hover:text-[#e57339]"><FaFacebook /></Link>

              <Link to='/' className="text-2xl hover:text-[#e57339]">
                <FaInstagram />
              </Link>
              <Link to='/' className="text-2xl hover:text-[#e57339]">
                <FaTwitter />
          ...
          <div>
            ...
            <div className="mt-3 flex">
              ...
              />
              <button className="bg-[#e57339] px-4 py-2 rounded-r-md font-semibold">
                Subscribe
              </button>
            </div>
          </div>
